...
public class Picture extends SimplePicture 
{
		...
		for (int r = 0; r < pixels.length; r++)
		{
			for (int c = 0; c < pixels[0].length; c++)
			{
				...
				if(pixelObj.getBlue() % 2 == 0)
					...
					pixelObj.setColor(Color.DARK_GRAY);
  ...
  {
    Picture beach = new Picture("changed_bc45f1089a5a88a6b429aa6f8b8a6954e71c02d45aab836b4fb43d34c34d563f.png");
    beach.explore();
    beach.decode();
    beach.explore();
  }
